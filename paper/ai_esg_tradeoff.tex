...
Table \ref{tab:breakdates} tests multiple candidate break dates. Regardless of whether the treatment is defined as starting in 2020 (GPT-3), 2021 (investment surge), 2022 (DALL-E), or 2023 (ChatGPT), the DiD coefficient remains statistically insignificant.
...
The key insight from this analysis is that the null result on Scope 1 emissions is robust to anticipation concerns. Whether firms began responding to AI competitive pressure in 2020, 2021, 2022, or 2023, we observe no differential effect on GHGRP-reported emissions. This confirms that the null finding reflects a measurement artifact (Scope 1 versus Scope 2) rather than timing issues. The generative AI buildout---which ChatGPT accelerated but did not initiate---drove Scope 2 emissions growth that is invisible in regulatory databases.
...
\textbf{Strategy 5: Instrumental Variables Using Data Center Tax Incentives.} State-level sales tax exemptions for data center equipment, enacted between 2003--2018 (Virginia 2009, Oregon 2003, North Carolina 2007), provide plausibly exogenous variation in data center capacity that predates the AI boom. These policy decisions were made for economic development reasons unrelated to post-2022 AI-driven emissions. Preliminary analysis shows strong first-stage relevance: state tax incentive generosity predicts data center power capacity with an F-statistic of 42.6, well above the weak instrument threshold of 10. This instrument could be used in a two-stage design where the first stage predicts electricity demand growth from tax incentives, and the second stage estimates the causal effect of AI-driven electricity demand on Scope 2 emissions.
